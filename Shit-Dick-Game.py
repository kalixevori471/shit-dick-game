...
win.title("Dick Shitgame") # Giving name to the game.
...
# Creating a shit pong ball for the game
...
pen.hideturtle()
pen.goto(0,260)
pen.write("ShitPlayer A: 0                    ShitPlayer B: 0 ",align="center",font=('Monaco',24,"normal"))
...
while True:
    ...
    if ball.xcor() > 390:   # right width paddle Border
        ...
        pen.clear()
        pen.write("ShitPlayer A: {}                    ShitPlayer B: {} ".format(player_a_score,player_b_score),align="center",font=('Monaco',24,"normal"))
